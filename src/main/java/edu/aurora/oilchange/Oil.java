...
/**
 * A unit of engine oil, with type, brand, quantity, price, and oil filter brand and cost.
 */
public class Oil {
    ...
    /**
     * Creates a new Oil object with the given parameters, accepting
     * doubles to represent currency.
     *
     ...
     */
    public Oil(String oilType, String oilBrand,
               int quantity, double pricePerQuart,
               String filterBrand, double filterCost) {
        this(oilType, oilBrand,
                quantity, BigDecimal.valueOf(pricePerQuart),
                filterBrand, BigDecimal.valueOf(filterCost));
    }
     ...
     */
    public Oil(String oilType, String oilBrand,
               int quantity, BigDecimal pricePerQuart,
               String filterBrand, BigDecimal filterCost) {
